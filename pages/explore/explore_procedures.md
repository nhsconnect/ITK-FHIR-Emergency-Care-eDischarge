...
<table style="width:100%;max-width: 100%;">
	...
	<tbody>
		...
		<tr>
			...
			<td>0 to many</td>
			<td>O</td>
			<td>Text and where supported a SNOMED CT concept to represent the anaesthesia issues carried in the FHIR element <b>Procedure.complication</b> and <b>Procedure.complicationDetail</b>.</td>
		</tr>
		<tr>
			<td>Comment</td>
