...
The Medications and medical devices section carries information about the patient's medication. Elements should be formatted as subheadings in any HTML sent. Where a value is marked as Text derived from SNOMED CT the section on [constructing clinical coded structures](build_medication_lists.html) should be consulted for further information. 
...
<table style="width:100%;max-width: 100%;">
	...
	<tbody>
		...
		<tr>
			...
			<th>&nbsp;</th>
			<th>optional</th>
			<th>*** Data items acting as placeholders for future 'advanced' structured dose syntax solution. insufficient  information to detail these further at present</th>
		</tr>
		<tr>
